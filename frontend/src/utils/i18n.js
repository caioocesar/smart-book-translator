...
const translations = {
  ...
  pt: {
    ...
    chunkSizeCharacters: 'Tamanho da Parte (caracteres)',
    ...
    plainText: 'Texto Simples (.txt)',
    wordDocument: 'Documento Word (.docx)',
    epubFormat: 'EPUB (.epub)',
  ...
  es: {
    ...
    chunkSizeCharacters: 'Tamaño de Parte (caracteres)',
    ...
    enterDeeplApiKey: 'Ingrese la clave de API DeepL',
    enterOpenaiApiKey: 'Ingrese la clave de API OpenAI',
    checking: 'Verificando',
